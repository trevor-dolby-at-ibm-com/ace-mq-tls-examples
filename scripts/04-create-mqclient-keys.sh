...
openssl req -new -newkey ec -pkeyopt ec_paramgen_curve:P-256 -subj "/C=US/ST=MN/L=Minneapolis/O=IBM/OU=ExpertLabs/CN=mqclient"  -keyout generated-output/mqclient-keys/mqclient.key -out generated-output/mqclient-keys/mqclient.csr -passout pass:changeit
...
openssl ec -out generated-output/mqclient-keys/mqclient-decrypted.key -in generated-output/mqclient-keys/mqclient.key -passin pass:changeit
...
cat generated-output/mqclient-keys/mqclient.key | openssl ec -noout -text -passin pass:changeit
