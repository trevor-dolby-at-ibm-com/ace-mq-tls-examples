...
openssl req -new -newkey ec -pkeyopt ec_paramgen_curve:P-256 -subj "/C=US/ST=MN/L=Minneapolis/O=IBM/OU=ExpertLabs/CN=mqserver"  -keyout generated-output/mqserver-keys/qm.key -out generated-output/mqserver-keys/qm.csr -passout pass:changeit
...
openssl ec -out generated-output/mqserver-keys/qm-decrypted.key -in generated-output/mqserver-keys/qm.key -passin pass:changeit
#openssl rsa -out generated-output/mqserver-keys/qm-decrypted.key -in generated-output/mqserver-keys/qm.key -passin pass:changeit
...
cat generated-output/mqserver-keys/qm.key | openssl ec -noout -text -passin pass:changeit
