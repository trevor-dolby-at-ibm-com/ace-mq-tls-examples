...
openssl pkcs12 -chain -CAfile generated-output/ace-demo-CA1/ace-demo-CA1.crt -inkey generated-output/mqserver-keys/qm.key -in generated-output/mqserver-keys/qm.crt -export -out generated-output/mqserver-keys/qm.p12 -passin pass:changeit -passout pass:changeit
